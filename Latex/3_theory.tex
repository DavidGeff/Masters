...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{figs/ch3/Beam-divergence.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{figs/ch3/multi_return.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{figs/ch3/avia1.png}
