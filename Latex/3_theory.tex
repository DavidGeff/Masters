...
Using \ac{LiDAR} is not without its disadvantages. \ac{LiDAR} sensors are often more expensive than other traditional remote sensing hardware and as it is a less well established method there are fewer options available. Unlike cameras, which can recover non-geometric details such as target colour and texture, \ac{LiDAR} is only able to recover the three-dimensional geometry of the target. \ac{Radar} outperforms \ac{LiDAR} in certain applications. It is capable of much larger detection ranges than \ac{LiDAR} and is also unaffected by adverse environmental conditions such as smoke, rain, and fog.
...
\begin{figure}[H]
    ...
    \caption{\textbf{Livox Avia.} Taken from \cite{AviaLiDARSensor}.}
    \label{fig:avia}
\end{figure}
%----------------------------------------------------
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.33\textwidth}
        ...
        %\caption{first figure}
    \end{minipage}\hfill
    \caption{\textbf{Livox Avia Repetitive Scanning Pattern.} Taken from \cite{AviaLiDARSensor}.}
    \label{fig:rep}
\end{figure}
%----------------------------------------------------
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.33\textwidth}
        ...
        %\caption{first figure}
    \end{minipage}\hfill
    \caption{\textbf{Livox Avia Non-Repetitive Scanning Pattern.} Taken from \cite{AviaLiDARSensor}.}
    \label{fig:non_rep}
\end{figure}
%----------------------------------------------------
...
\end{tabular}
\caption{Livox Avia Specifications. The parameters}
\label{tab:AVIA_spec}
\end{table}
%----------------------------------------------------
