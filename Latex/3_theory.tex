...
%****************************************************
\chapter{Introduction to LiDAR and Point Cloud Processing}
\label{ch:theory}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.33\textwidth}
        \centering
        \includegraphics[width=1\linewidth]{figs/camera.png} % first figure itself
        %\caption{first figure}
    \end{minipage}\hfill
    \begin{minipage}{0.33\textwidth}
        \centering
        \includegraphics[width=1\linewidth]{figs/radar.png} % second figure itself
        %\caption{second figure}
    \end{minipage}
    \begin{minipage}{0.33\textwidth}
        \centering
        \includegraphics[width=1\linewidth]{figs/lidar.png} % first figure itself
        %\caption{first figure}
    \end{minipage}\hfill
...
\begin{figure}[H]
    ...
    \caption{\textbf{Beam Divergence.} Taken from \textcite{kukkoMobileLaserScanning2013}.}
...
\begin{figure}[H]
    ...
    \caption{\textbf{Self-shadowing.} Taken from \textcite{landyNumericalExperimentalEvaluation2015}.}
    \label{fig:shadow}
\end{figure}
%----------------------------------------------------
...
\begin{figure}[H]
    ...
    \caption{\textbf{Risley Prism.} Taken from \textcite{brazealRigorousObservationModel2021}.}
    \label{fig:risley}
\end{figure}
%----------------------------------------------------
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.33\textwidth}
        ...
        %\caption{first figure}
    \end{minipage}\hfill
    \caption{\textbf{Livox Avia Repetitive Scanning Pattern.} Taken from \textcite{AviaLiDARSensor}.}
    \label{fig:rep}
\end{figure}
%----------------------------------------------------
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.33\textwidth}
        ...
        %\caption{first figure}
    \end{minipage}\hfill
    \caption{\textbf{Livox Avia Non-Repetitive Scanning Pattern.} Taken from \textcite{AviaLiDARSensor}.}
    \label{fig:non_rep}
\end{figure}
%----------------------------------------------------
...
A common method for determining the orientation of two point clouds is through the processing of \ac{IMU} data collected during the point cloud capture process. Not all \ac{LiDAR} sensors have a built-in \ac{IMU}, but its inclusion is becoming more common in modern sensors. \ac{IMU} data can be fed into attitude estimation algorithms such as Kalman filters (discussed in the Section below) to determine the orientation of the sensor during data collection. This orientation data can then be used to align point clouds captured from different orientations to allow for the concatenation of multiple point clouds into a single, more detailed point cloud.
...
\begin{figure}[H]
    ...
    \caption{\textbf{Water and Ice Absorption Spectra.} Absorption as the imaginary part of refraction (extinction coefficient). Taken from \textcite{dozierEstimationPropertiesAlpine1989}.}
    \label{fig:water}
\end{figure}
%----------------------------------------------------
...
\begin{figure}[H]
    ...
    \caption{\textbf{Various Ice Spectral Albedo.} Taken from \textcite{brandtSurfaceAlbedoAntarctic2005}.}
    \label{fig:ice}
\end{figure}
%----------------------------------------------------
...
\begin{figure}[H]
    ...
    \caption{\textbf{Snow Spectral Albedo.} Taken from \textcite{brandtSurfaceAlbedoAntarctic2005}.}
    \label{fig:snow}
\end{figure}
%----------------------------------------------------
