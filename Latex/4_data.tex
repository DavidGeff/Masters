...
\begin{figure}[H]
    ...
    \caption{\textbf{SCALE Winter 2022 Cruise Track.}}{Taken from *marchello kmz*}
    \label{fig:map}
\end{figure}
%----------------------------------------------------
