...
The first experiment detailed in Section \ref{subsec:ch5.section2.subsec1} investigates the sensor's ability to resolve known geometric shapes at known distances and angles, from a stationary platform. 

The second experiment detailed in Section \ref{subsec:ch5.section2.subsec2} was conducted to collect data from the Avia's \ac{IMU} while the sensor was subjected to known motion. This data was used to investigate the feasibility of compensating for the motion of a moving observation platform.
