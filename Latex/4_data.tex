...
\centering
  ...
  \end{minipage}
  \caption{\textbf{Simulated Motion Experimental Setup.}}{The Avia was mounted to the Stewart Platform using a custom 3D-printed mount, and a seconday laptop was used to run the Platform's motion routines.}
