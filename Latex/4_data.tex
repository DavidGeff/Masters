...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{figs/ch4/field_boards.JPG}
...
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=0.95\linewidth]{figs/ch4/board_c.jpg}
  \caption{\textbf{Target C.}}
  \label{fig:target_c}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=0.95\linewidth]{figs/ch4/board_d.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{figs/ch4/Aalto_Livox.jpeg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figs/ch4/lidar.jpg}
