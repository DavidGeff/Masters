...
\\point intensities are useful for identifying pancakes, but not used in these algorithms. change in intensities at pancake edges could be used to help identify pancakes and likely are produced by ridges on pancake edges and other surface geometries.

DBScan performs better with sparse data, OPTICS better with dense data.
