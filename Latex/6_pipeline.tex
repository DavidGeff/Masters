...
\label{subsec:ch4.section1.subsec3}
...
The estimated wave parameters could be used to improve understanding of wave-ice interactions in the \ac{MIZ}, as well as providing in-situ data for the improvement of current models of wave propagation, attenuation and interactions with sea ice. This data could also be used in the validation of estimates from other remote sensing methods used to observe the \ac{MIZ}, such as \ac{SAR}.
...
\label{subsec:ch4.section1.subsec4}
...
%----------------------------------------------------
\subsection{Motion Compensation}
\label{sec:ch4.section3.subsec1}
...
%----------------------------------------------------
\subsection{De-noising}
\label{sec:ch4.section3.subsec2}
...
%----------------------------------------------------
\subsection{Wave Parameter Estimation}
\label{subsec:ch4.section3.subsec3}
...
%----------------------------------------------------
\subsection{Pancake Identification}
\label{subsec:ch4.section3.subsec4}
...
\label{subsec:ch4.section3.subsec4.subsubsec1}
...
\label{subsec:ch4.section3.subsec4.subsubsec2}
...
\label{subsec:ch4.section3.subsec4.subsubsec3}
