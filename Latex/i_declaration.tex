...
\begin{enumerate}[label=\arabic*.]
    ...
    \begin{enumerate}[label=\alph*.]
        ...
        \begin{enumerate}[label=\roman*.]
            \item The debugging and testing of code.
            \item Assistance in the understanding of unfamiliar concepts and techniques.
            \item Brainstorming and compiling lists of potential approaches to solving problems.
            \item Editing grammar and spelling in the writing of this report.
        \end{enumerate}
        \vspace{1em}
    \end{enumerate}
...
\begin{tabular}{@{}ll@{}}
\textbf{Word count} & 23294 words {\footnotesize (excluding preamble, appendices and bibliography)}\\
\textbf{Page count} & 69 pages {\footnotesize (excluding preamble, appendices and bibliography)} \\
\end{tabular}
&
\begin{minipage}[t]{0.45\textwidth}
    \raggedleft
    \includegraphics[height=2cm]{figs/signature.jpg} % Adjust height as needed
    \vskip 1mm
