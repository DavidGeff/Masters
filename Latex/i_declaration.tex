...
\begin{tabular}{@{}ll@{}}
\textbf{Word count} & xxxx words {\footnotesize (excluding preamble, appendices and bibliography)}\\
\textbf{Page count} & xxxx pages {\footnotesize (excluding preamble, appendices and bibliography)} \\
\end{tabular}
&
