...
The normals estimation process successfully estimated normal vectors for each point in the four reconstructed targets. The normal vectors generally follow the geometry of the reconstructed targets seen in Section \ref{subsec:ch7.section1.subsec1}. The majority of the normal vectors point outwards from the surfaces of the targets, as expected, but s small nubmer of normal vectors appear to be inverted (see the region encircled in red in Figure \ref{fig:A15Norm}), pointing inwards towards the interior of the targets or downwards towards the ground plane.

In the region encircled in green in Figure \ref{fig:A15Norm}, the curved face of Target A can be seen with the normal vectors pointing upwards and outwards from the surface, as expected. In Figure \ref{fig:B15Norm}, the front edge of the trough-like shape of Target B can be seen in the region encircled in green, with the normal vectors pointing in the direction of the sensor aperture. The region encircled in red is likely causwed by the leading edge of the trough creating a shadowing effect which leads to a poor reconstruction of the surface in this region, which in turn leads to inaccurate normals estimation. In Figure \ref{fig:C15Norm}, the curved edge of Target C can be seen in the region encircled in green, with the normal vectors pointing upwards and outwards from the surface, towrds the sensor aperture. In Figure \ref{fig:D15Norm}, the region encircled in green is likely caused by the raised edge of the target creating a poor reconstrction, similar to the region encircled in red in Figure \ref{fig:B15Norm}. Above the green circle the normals can be seen recreating the trough-like shape of Target D, with normals pointing upwards towards the axis of curvature of the target.
