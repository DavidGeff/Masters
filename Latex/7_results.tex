...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{figs/kf_resid_10.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{figs/eskf_resid_10.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{figs/kf_resid_5.png}
    \caption{\textbf{KF residuals.}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{figs/eskf_resid_5.png}
    \caption{\textbf{ESKF residuals.}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{figs/fit_view.png}
...
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=0.95\linewidth]{figs/ransac_amp_truth.png}
  \caption{\textbf{Estimated Amplitude.}}
  \label{fig:amp}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=0.95\linewidth]{figs/ransac_period_truth.png}
...
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=0.95\linewidth]{figs/rand_amp.png}
  \caption{\textbf{Estimated Amplitude, 5 Samples.}}
  \label{fig:rand_amp}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=0.95\linewidth]{figs/rand_per.png}
...
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=0.9\linewidth]{figs/2290frame.png}
  \caption{\textbf{Scene 1, 1 Frame.}}
  \label{fig:2290Frame}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=0.9\linewidth]{figs/2291frame.png}
...
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=0.9\linewidth]{figs/660frame.png}
  \caption{\textbf{Scene 2, 1 Frame.}}
  \label{fig:660Frame}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=0.9\linewidth]{figs/660_DB.png}
...
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=0.9\linewidth]{figs/660_VDB.png}
  \caption{\textbf{VDBScan.}}
  \label{fig:clust660VDB}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=0.9\linewidth]{figs/660_OPT.png}
...
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=0.9\linewidth]{figs/661frame.png}
  \caption{\textbf{Scene 2, 2 Frames.}}
  \label{fig:661Frame}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=0.9\linewidth]{figs/660_661_DB.png}
  \caption{\textbf{DBScan.}}
...
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=0.9\linewidth]{figs/660_661_VDB.png}
  \caption{\textbf{VDBScan.}}
  \label{fig:clust661VDB}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=0.9\linewidth]{figs/660_661_OPT.png}
  \caption{\textbf{OPTICS.}}
...
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=0.9\linewidth]{figs/980frame.png}
  \caption{\textbf{Scene 3, 1 Frame.}}
  \label{fig:980Frame}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=0.9\linewidth]{figs/980_DB.png}
  \caption{\textbf{DBScan.}}
...
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=0.9\linewidth]{figs/980_VDB.png}
  \caption{\textbf{VDBScan.}}
  \label{fig:clust980VDB}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=0.9\linewidth]{figs/980_OPT.png}
  \caption{\textbf{OPTICS.}}
...
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=0.9\linewidth]{figs/981frame.png}
  \caption{\textbf{Scene 3, 2 Frames.}}
  \label{fig:981Frame}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=0.9\linewidth]{figs/980_981_DB.png}
  \caption{\textbf{DBScan.}}
...
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=0.9\linewidth]{figs/980_981_VDB.png}
  \caption{\textbf{VDBScan.}}
  \label{fig:clust981VDB}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=0.9\linewidth]{figs/980_981_OPT.png}
  \caption{\textbf{OPTICS.}}
...
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=0.9\linewidth]{figs/5620frame.png}
  \caption{\textbf{Scene 4, 1 Frame.}}
  \label{fig:5620Frame}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=0.9\linewidth]{figs/5620_DB.png}
  \caption{\textbf{DBScan.}}
...
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=0.9\linewidth]{figs/5620_VDB.png}
  \caption{\textbf{VDBScan.}}
  \label{fig:clust5620VDB}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=0.9\linewidth]{figs/5620_OPT.png}
  \caption{\textbf{OPTICS.}}
...
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=0.9\linewidth]{figs/5621frame.png}
  \caption{\textbf{Scene 4, 2 Frames.}}
  \label{fig:5621Frame}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=0.9\linewidth]{figs/5620_5621_DB.png}
  \caption{\textbf{DBScan.}}
...
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=0.9\linewidth]{figs/5620_5621_VDB.png}
  \caption{\textbf{VDBScan.}}
  \label{fig:clust5621VDB}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=0.9\linewidth]{figs/5620_5621_OPT.png}
  \caption{\textbf{OPTICS.}}
