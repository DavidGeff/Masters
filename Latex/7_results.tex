...
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=\linewidth]{figs/ch7/A10.png}
...
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=\linewidth]{figs/ch7/D10.png}
...
\begin{figure}[H]
    ...
    \caption{\textbf{De-noised Frame.}}{The ocean surface is still clearly visible in the lower left of the frame, with the cone of noise in front of the sensor's aperture removed. The horizonal feature that remains, running along z = -7 m, is a part of the railing on the 7th floor deck where the data was collected. Point return intensity is represented by the colour of the points.}
    \label{fig:thresh}
\end{figure}
%----------------------------------------------------
