...
%****************************************************
\chapter{Pre-processing and Sensor Characterisation}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{figs/ch5/avia_axes.png}
...
This pre-processing could be automated in future work by initially aligning the Avia and motion capture system's coordinate frames before data collection, and by using a common trigger signal to start data collection on both systems simultaneously, thus eliminating the need for manual time synchronisation and frame alignment.
