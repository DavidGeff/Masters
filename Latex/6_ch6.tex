...
Angle estimate residuals (the difference between the motion capture ground truth and the filter's estimates) were computed and used as the primary metric for comparing the filters relative performance. The resduals were also used in the tuning of both filters.

To tune each filter's parameters, iterative adjustments were made to the parameters until the mean residuals reached a minimum.
