...
\begin{minipage}{.5\textwidth}
    \centering
    \includegraphics[width=0.95\linewidth]{figs/sic_feb.png}
  \end{minipage}%
  \begin{minipage}{.5\textwidth}
    \centering
    \includegraphics[width=0.95\linewidth]{figs/sic_sept.png}
  \end{minipage}
  \caption{\textbf{Sea Ice Extent.} Average sea ice concentration for February (left) and September (right) 2024, the annual minimum and maximum respectively. Taken from \cite{BrowseImageSubset}.}
  \label{fig:ice_exten}
\end{figure}
%----------------------------------------------------
