...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{figs/miz.png}
...
Pancake ice is the name given to roughly circular, consolidated ice floes, seen below in Figure \ref{fig:pancake_floes}, commonly found in polar marginal ice zones where turbulent wave and wind activity is present (\cite{doblePancakeIceFormation2003}). The growth and fusion of pancake ice is the main driver of pack ice in the Antarctic.

%----------------------------------------------------
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{figs/pancake_floes.jpg}
    \caption{\textbf{Pancake Ice Floes in the MIZ.} Captured during the SCALE Winter 2019 cruise aboard the \textit{S.A. Agulhas II}. R.A. Verrinder.}
...
\begin{figure}[H]
    ...
    \caption{\textbf{Pancake ice formation process.} Taken from \textcite{shenConceptualModelPancakeice2001}.}
