...
In the Antarctic MIZ wave activity is predominantly driven by wind activity and atmospheric pressure, resulting in wave energy most commonly occuring at frequencies below 0.1 Hz (\cite{thomsonWavePropagationMarginal2022}). These waves have been recorded propagating over 100 km into the MIZ, propagation to this extent is a rare occurance in the Arctic. These waves are classified as gravity waves (\cite{holthuijsenWavesOceanicCoastal2007}), as the primary force attempting to return the disturbance to equilibrium is gravity.
...
These gaps in our understanding of the MIZ is a clear indication that further investigation into the dynamics of the region is neccssary
