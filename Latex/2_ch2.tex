...
Remote sensing has been the most common way of gathering data on the Antarctic since satellite sensors became widespread and a standard method for Earth observation and data collection.
Remote sensing has many advantages, it allows for long term, consistant data collection, large areas can be surveyed without the need for a physical presence in the region of interest and it can be more cost effective than in-situ data collection.
Remotse sensing in this region typically takes the form of Synthetic Aparture Radar (SAR) imaging, Optical imaging and laser altimetry \cite{maslanikRemoteSensingAntarctica1990}. 

Remote sensing has widened our knowledge of the Antarctic, it has allowed for tracking of sea ice coverage, storms and *maybe* ocean currents.
