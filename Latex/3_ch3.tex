...
Water is most transparent to radiation within the visible region (roughly 400 - 700 nm), outside this region radiation absorption increases rapidly (\cite{warrenOpticalPropertiesIce2019}). Near infrared radiation cannot penetrate far into water and is almost entirely absorbed. As seen in Figure \ref{fig:water}, water and ice broadly have similar absorption characteristics across the visual and near infrared regions of the electromagnetic spectrum.

%----------------------------------------------------
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{figs/ice.png}
    \caption{\textbf{Various Ice Absorption Spectra.} Absorption as the imaginary part of refraction (extinction coefficient). Taken from \cite{brandtSurfaceAlbedoAntarctic2005}}
    \label{fig:ice}
\end{figure}
%----------------------------------------------------
...
\begin{figure}[H]
    ...
    \caption{\textbf{Snow Absorption Spectra.} Absorption as the imaginary part of refraction (extinction coefficient). Taken from \cite{brandtSurfaceAlbedoAntarctic2005}}
    \label{fig:snow}
\end{figure}
%----------------------------------------------------

The physical structure and composition of ice varies greatly and thus so do its optical properties. 
